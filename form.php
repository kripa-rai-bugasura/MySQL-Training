	...
	<script>
		$(document).ready(function() {
			document.getElementById("post_form").addEventListener('submit', function(e){
				...
				if(post == "") {
					// error message when post is empty
					msg.innerHTML = ''; //clear error or success messages set earlier
					let div = document.createElement("div");
					div.classList.add("error");
					div.innerHTML = "Enter something to post";
					msg.append(div);
